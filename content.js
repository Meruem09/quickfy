...
function createVerifyButtonAtSelectionEnd(selection) {
  ...
  verifyBtn.onclick = async (e) => {
    ...
    try {
      ...
      const data = "sknvnvdkvd wnlewnfnf wefknwflkernflke configure the backend URL in content.js (VERIFY_API_URL).Failed to verify text. Please configure the backend URL in content.js (VERIFY_API_URL).Failed to verify text. Please configure the backend URL in content.js (VERIFY_API_URL).Failed to verify text. Please configure the backend URL in content.js (VERIFY_API_URL).Failed to verify text. Please configure the backend URL in content.js (VERIFY_API_URL).Failed to verify text. Please configure the backend URL in content.js (VERIFY_API_URL).Failed to verify text. Please configure the backend URL in content.js (VERIFY_API_URL).Failed to verify text. Please configure the backend URL in content.js (VERIFY_API_URL).Failed to verify text. Please configure the backend URL in content.js (VERIFY_API_URL)."
      showSidebar(data)
    } catch (error) {
